    ...
    do
        ...
        do
            ...
            do
                ...
                python code/train.py --val_type=normal --sigmaRui_sq=$sigmaRui_sq --batch_size=$batch_size --num_workers=$num_workers --pretraining_epochs=$pe --theta_val=$theta --mnet_name=$mnet_name > output/salida_${SERVER}_train_${BASHPID}.txt 2>&1
