...
def set_opts():
    ...
    parser.add_argument('--log_dir', default='./log_mse_sum_kl_test_al0_9_pre', type=str, metavar='PATH', help="Path to save the log file, (default: ./log)")
    parser.add_argument('--model_dir', default='./model_mse_sum_kl_test_al0_9_pre', type=str, metavar='PATH', help="Path to save the model file, (default: ./model)")
    ...
    # hyper-parameters
    parser.add_argument('--alpha_e2', default=5e-2, type=float, help="Variance for prior of p(x), (default: 1e-6)")
    parser.add_argument('--alpha_h2', default=5e-2, type=float, help="Variance for prior of p(x), (default: 1e-6)")

    parser.add_argument('--sigma2', default=1e-1, type=float, help="Variance for p(y|k, x), (default: 1e-5)")
    parser.add_argument('--al', default=9e-1, type=float, help="parameters of loss, (default: 1e-5)")
