import torch
from networks2.unet2 import UNet
from networks2.unet_add_sft2 import UNetAddSFT
...
def get_dnet(net_name):
    if net_name == 'unet_sft_9':
        ...
        return UNetAddSFT(in_nc=3, out_nc=2, nc=64, num_blocks=6)
        ...
        return UNet(in_nc=3, out_nc=6, nc=64, num_blocks=9)
