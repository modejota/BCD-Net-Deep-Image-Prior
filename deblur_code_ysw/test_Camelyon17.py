...
train_centers = [4]  # This will take images from centers 0, 2 and 4
tumor_patches_ids = []
normal_patches_ids = []
unknown_patches_ids=[]
...
# im_path = '/work/Camelyon17/work/DECONVOLUCIONES/Original/center_0'
#
# filepaths = glob.glob(im_path + '/*/annotated/*.jpg')
#
# ImgNum = len(filepaths)
ImgNum=len(OD_list)
# for img_no in range(ImgNum-10280,ImgNum):
for img_no in range(ImgNum):
    ...
    n = imgName.rfind("center_4")
    img_name = imgName[n:]
    print(img_name)
    im_dir = os.path.dirname(img_name)
    print(dir)

    m_dir = os.path.join('/work/work_ysw/Deblur_Code/test_result/BCDnet_al0.9_partial', im_dir)
