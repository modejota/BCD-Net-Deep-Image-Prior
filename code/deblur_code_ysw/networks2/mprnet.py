...
class MPRNet(nn.Module):
    ...
    def forward(self, x3_img, kernel=None):
        ...
        stage3_img[:,:3,:,:] = stage3_img[:,:3,:,:] + x3_img


        return [stage3_img, stage2_img, stage1_img]

if __name__ == "__main__":
    model = MPRNet(in_c=3, out_c=6, n_feat=96, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3,
                 reduction=4, bias=False).cuda()
