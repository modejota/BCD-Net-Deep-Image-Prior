...
def set_opts():
    ...
    parser.add_argument('--patch_size', type=int, default=64, help="Patch size of data sample,  (default:64)")
    parser.add_argument('--epochs', type=int, default=120, help="Training epohcs")
    parser.add_argument('-p', '--print_freq', type=int, default=10, help="Print frequence (default: 10)")
    ...
    parser.add_argument('--log_dir', default='./log_mse_sum_kl_test_al0_8_pre_loglikehood', type=str, metavar='PATH', help="Path to save the log file, (default: ./log)")
    parser.add_argument('--model_dir', default='./model_mse_sum_kl_test_al0_8_pre_loglikehood', type=str, metavar='PATH', help="Path to save the model file, (default: ./model)")
    ...
    # hyper-parameters
    parser.add_argument('--prior_sigma_e2', default=5e-2, type=float, help="Variance for prior of p(x), (default: 5e-2)")
    parser.add_argument('--prior_sigma_h2', default=5e-2, type=float, help="Variance for prior of p(x), (default: 5e-2)")


    parser.add_argument('--alpha', default=8e-1, type=float, help="parameters of loss, (default: 7e-1)")
    parser.add_argument('--pre_kl', default=1e2, type=float, help="parameters of loss, (default: 1e2)")
    parser.add_argument('--pre_mse', default=1e-2, type=float, help="parameters of loss, (default: 1e-2)")
