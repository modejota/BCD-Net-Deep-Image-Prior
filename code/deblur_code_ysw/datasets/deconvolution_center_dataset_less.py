...
class DeconvolutionTrainDataset(Dataset):
    ...
    def scan_files(self, camelyon_dir):
        OD_img_list = []
        n_samples = 50000  # Desired size for the dataset, you can change this
...
class DeconvolutionTestDataset(Dataset):
    def __init__(self, data_path):
        ...
        n_samples = 8000  # Desired size for the dataset, you can change this
        #         camelyon_dir='/data/BasesDeDatos/Camelyon/Camelyon17/training/patches_224/'
    ...
    def __getitem__(self, index):
        ...
        # OD_img = normalize(OD_img, max_val=-np.log((1)/256), min_val=0.)
        # OD_img = normalize(OD_img, max_val=1., min_val=0.)
        # OD_img = OD_img / 255
...
if __name__ == "__main__":
    dataset = DeconvolutionTestCamelyonDataset(data_path = "/data/")
