...
def set_opts():
    ...
    parser.add_argument('--log_dir', default='./log_mse_sum_kl_test_al0_2', type=str, metavar='PATH', help="Path to save the log file, (default: ./log)")
    parser.add_argument('--model_dir', default='./model_mse_sum_kl_test_al0_2', type=str, metavar='PATH', help="Path to save the model file, (default: ./model)")
    ...
    parser.add_argument('--al', default=2e-1, type=float, help="parameters of loss, (default: 1e-5)")
