...
def set_opts():
    ...
    parser.add_argument('--use_image', action='store_true', help="Use the image itself as the input of the model instead of random noise")

    parser.add_argument('--approach', choices=['bcdnet_e1', 'bcdnet_e2', 'bcdnet_e3', 'bcdnet_e4L1', 'bcdnet_e4L2', 'cnet_e2'], help="Approach used during training")
    ...
    parser.add_argument('--save_weights_folderpath', type=str, metavar='PATH', help="Path to the folder where to save the model weights. Only for individual processing")
